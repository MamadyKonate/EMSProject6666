...
using EMSProject6.Data;
using EMSProject6.Models;
using Newtonsoft.Json;
using System.Collections.Generic;
using System.Linq;

namespace EMSProject6.Controllers
{  
    ...
    public static class ViewModelData
    {
        ...
        /// </summary>
        static AllDropDownListData Alldrop { get; } = new AllDropDownListData(new EMSProject6.Data.EMSDbContext());
        /// <summary>
